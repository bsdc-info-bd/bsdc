  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'BSDC',
        description:
          'The proud software development community of Bangladesh. Connect, share, learn, and grow with developers from Bangladesh and around the world.',
        theme_color: '#0A8F3C',
        ...
        categories: ['developer', 'community', 'social', 'education'],
        lang: 'en',
        dir: 'ltr',
      },
      workbox: {
